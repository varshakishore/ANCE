# tokenization
wiki_dir="../../DPR/dpr/downloads/data/wikipedia_split/" # path for psgs_w100.tsv downloaded with DPR code
ans_dir="../../DPR/dpr/downloads/data/retriever/qas/" # path for DPR question&answer csv files
question_dir="../../DPR/dpr/downloads/data/retriever/" # path for DPR training data
...
passage_path="../../DPR/dpr/downloads/data/wikipedia_split/"
test_qa_path="../../DPR/dpr/downloads/data/retriever/qas/"
...
--passage_path $passage_path --test_qa_path $test_qa_path \
"
